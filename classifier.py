...
# Automatically detect the directory of this script file
BASE_DIR = os.path.dirname(os.path.abspath(__file__))

# Compose the full path to the labels file inside the same directory as this script
file_path = os.path.join(BASE_DIR, 'imagenet1000_clsid_to_human.txt')
