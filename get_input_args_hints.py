...
def get_input_args():
    ...
    # args.arch which CNN model to use for classification, args.dogfile path to
    # text file with names of dogs.
    parser.add_argument('--dir', type=str, default='pet_images/', 
                        help='path to folder of images')
    
    # TODO: 1a: add type and help to arch and dogfile arguments
    parser.add_argument('--arch', type=str, default='vgg',
                        help='CNN model architecture: resnet, alexnet, or vgg')
    parser.add_argument('--dogfile', type=str, default='dognames.txt',
                        help='text file with dog names')

    # TODO: 1b: Return parsed argument collection
