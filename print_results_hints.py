...
def print_results(results_dic, results_stats_dic, model, 
    ...
    for key in results_stats_dic:
        # TODO: 6b. Print all percentage statistics (keys that start with 'p')
    ...
    if (print_incorrect_dogs and 
        ...
        for key in results_dic:
            # TODO: 6c. Print pet label and classifier label when dog classification is wrong
            # Pet Image Label is a Dog but Classifier says NOT a Dog OR vice versa
